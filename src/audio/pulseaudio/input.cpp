...
smartspeaker::AudioInputPulseSimple::AudioInputPulseSimple(App *app) : app(app) {}

smartspeaker::AudioInputPulseSimple::~AudioInputPulseSimple() {
  free(pcm);
...
bool smartspeaker::AudioInputPulseSimple::init(gchar *audio_input_device,
...
smartspeaker::AudioFrame
smartspeaker::AudioInputPulseSimple::read_frame(int32_t frame_length) {
  int read_frames = 0;
  int error;
