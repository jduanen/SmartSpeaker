...
smartspeaker::AudioInputAlsa::AudioInputAlsa(App *app) : app(app) {}

smartspeaker::AudioInputAlsa::~AudioInputAlsa() {
  free(pcm);
  free(pcm_mono);
  free(pcm_playback);
  free(pcm_filter);
...
bool smartspeaker::AudioInputAlsa::init_pcm(gchar *input_audio_device) {
  alsa_handle = NULL;
  int error_code =
...
bool smartspeaker::AudioInputAlsa::init_speex() {
  spx_int32_t tmp;
...
bool smartspeaker::AudioInputAlsa::init(gchar *audio_input_device, int m_sample_rate,
...
smartspeaker::AudioFrame smartspeaker::AudioInputAlsa::read_frame(int32_t frame_length) {
  int read_frames = 0;
  int error;
