...
smartspeaker::AudioVolumeController::AudioVolumeController(App *app) : app(app) {
...
void smartspeaker::AudioVolumeController::duck() { driver->duck(); }

void smartspeaker::AudioVolumeController::unduck() { driver->unduck(); }

void smartspeaker::AudioVolumeController::set_volume(int volume) {
...
void smartspeaker::AudioVolumeController::adjust_volume(int delta) {
  auto current = driver->get_volume();
  auto updated = current + delta;
  set_volume(updated);
}

void smartspeaker::AudioVolumeController::increment_volume() {
  adjust_volume(VOLUME_DELTA);
}

void smartspeaker::AudioVolumeController::decrement_volume() {
  adjust_volume(-VOLUME_DELTA);
}
